...
namespace WindowsFormsApp1.UserControls
{
    public partial class Purchase : UserControl
    {
        ...
        private void FillVendorNameBox() 
        {
            string query = "SELECT Name FROM VendorInformation1";
        ...
        {
            conn.Open();
            string query = "SELECT * FROM AddPurchase";
        ...
        private void addbtn_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO AddPurchase(Name, Quantity, Price, Total) VALUES('"+this.vendorbox.Text+"', '"+this.quantitybox.Text+"', '"+this.pricebox.Text+"', '"+result+"')";
            SqlCommand cmd = new SqlCommand(query, conn);
            SqlDataReader dr;
            conn.Open();
            dr = cmd.ExecuteReader();
            ...
            conn.Open();
            string query1 = "Select Count(*) from AddPurchase";
        ...
        private void SavedPurchases()
        {
            conn.Open();
            string query = "SELECT * FROM TemporaryPurchase";
            SqlDataAdapter adapter = new SqlDataAdapter(query, conn);
            SqlCommandBuilder cmd = new SqlCommandBuilder(adapter);
            var dataset = new DataSet();
            adapter.Fill(dataset);
        ...
        private void bunifuButton2_Click(object sender, EventArgs e)
        {
            ...
            string query1 = "INSERT INTO TemporaryPurchase (Date, VendorName, PhoneNumber, TotalProduct, GrandTotal, Cash) VALUES('" + this.datebox.Text + "', '" + this.vendorbox.Text + "', '" + PhoneNumber() + "', '" + this.totalproductbox.Text + "', '" + this.gtotalbox.Text + "', '" + Checkbox() +"')";
            SqlCommand cmd1 = new SqlCommand(query1, conn);
            SqlDataReader dr1;
            conn.Open();
            ...
            string query2 = "Delete AddPurchase";
        ...
        private void gtotalbox_TextChanged(object sender, EventArgs e)
        {
        ...
        private string PhoneNumber() 
        {
            ...
            string query = "SELECT * FROM VendorInformation1 where Name = '" + this.vendorbox.Text + "'";
            SqlCommand cmd = new SqlCommand(query, conn);
            SqlDataReader dr;
            try
            {
        ...
        private void dataGridView3_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView3.Rows[e.RowIndex].Cells[e.ColumnIndex].Value != null)
            {
                ...
                namebox.Text = dataGridView3.Rows[e.RowIndex].Cells["VendorName"].FormattedValue.ToString();
            }
        }

        private void bunifuButton3_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Do you want to delete this purchase ? ", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {
                string query = "DELETE FROM TemporaryPurchase WHERE VendorName = '" + this.namebox.Text + "'";
                SqlCommand cmd = new SqlCommand(query, conn);
                SqlDataReader dr;
                conn.Open();
                dr = cmd.ExecuteReader();
        ...
        private void bunifuButton1_Click(object sender, EventArgs e)
        {
            ...
            string query = "UPDATE TemporaryPurchase SET Cash = '"+paid+"' WHERE VendorName = '"+this.namebox.Text+"'";
            SqlCommand cmd = new SqlCommand(query, conn);
            SqlDataReader dr;
            conn.Open();
            dr = cmd.ExecuteReader();
        ...
        {
            string query = "SELECT * FROM TemporaryPurchase WHERE VendorName LIKE '%" + vendorname + "%'";
